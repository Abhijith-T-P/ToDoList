...
public class DataSource {
    ...
    public void deleteTask(long taskId,Context context) {
        Toast.makeText(context,String.valueOf(taskId),Toast.LENGTH_SHORT).show();
        Log.d("deleteTask",String.valueOf(taskId));
